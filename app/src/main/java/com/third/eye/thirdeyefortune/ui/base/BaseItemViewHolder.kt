...
import com.third.eye.thirdeyefortune.utils.display.Toaster
import com.third.eye.thirdeyefortune.ThirdEyeFortuneApplication
import com.third.eye.thirdeyefortune.di.components.DaggerViewHolderComponent
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as ThirdEyeFortuneApplication).applicationComponent)
